...
public class LuminaSword {
    private static final String ITEM_ID = "lumina_sword";
    ...
    public static ItemStack createItem() {
        ...
        meta.setDisplayName("§fLumina Sword");
    ...
    public static boolean isLuminaSword(ItemStack item) {
